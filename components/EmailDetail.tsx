...
const EmailDetail: React.FC<EmailDetailProps> = ({ message, onClose }) => {
    ...
    <html>
      ...
      <body>
        <div id="content-wrapper">
          ${createSafeHtml(message.html && message.html.length > 0 ? message.html : [`<pre style="white-space: pre-wrap; word-wrap: break-word;">${message.text}</pre>`])}
        </div>
      </body>
    </html>
  `;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-800 max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="flex-shrink-0 mb-4">
        <button onClick={onClose} className="flex items-center gap-2 text-gray-600 font-semibold hover:text-black transition-transform duration-200 ease-in-out hover:scale-105 active:scale-100">
      ...
      <div className="flex-grow">
          <div className="bg-white rounded-b-lg shadow-md flex flex-col border-x border-b border-gray-200">
